...
class AnalyticsPlays400Error(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "type", "status", "detail", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "type", "status", "detail", "name", ], str]):
