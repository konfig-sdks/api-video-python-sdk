...
class PlayerThemeAssets(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["logo", "link", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["logo", "link", ], str]):
