...
class RequiredVideoThumbnailPickPayload(TypedDict):
...
class OptionalVideoThumbnailPickPayload(TypedDict, total=False):
    pass

class VideoThumbnailPickPayload(RequiredVideoThumbnailPickPayload, OptionalVideoThumbnailPickPayload):
    pass
