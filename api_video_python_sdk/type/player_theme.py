...
from api_video_python_sdk.type.player_theme_assets import PlayerThemeAssets

class RequiredPlayerTheme(TypedDict):
    playerId: str

class OptionalPlayerTheme(TypedDict, total=False):
...
class PlayerTheme(RequiredPlayerTheme, OptionalPlayerTheme):
    pass
