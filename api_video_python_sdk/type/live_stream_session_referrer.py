...
class RequiredLiveStreamSessionReferrer(TypedDict):
    pass

class OptionalLiveStreamSessionReferrer(TypedDict, total=False):
...
class LiveStreamSessionReferrer(RequiredLiveStreamSessionReferrer, OptionalLiveStreamSessionReferrer):
    pass
