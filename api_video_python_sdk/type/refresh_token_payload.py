...
class RequiredRefreshTokenPayload(TypedDict):
...
class OptionalRefreshTokenPayload(TypedDict, total=False):
    pass

class RefreshTokenPayload(RequiredRefreshTokenPayload, OptionalRefreshTokenPayload):
    pass
