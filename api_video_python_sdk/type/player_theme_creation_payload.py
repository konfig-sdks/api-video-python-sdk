...
class RequiredPlayerThemeCreationPayload(TypedDict):
    pass

class OptionalPlayerThemeCreationPayload(TypedDict, total=False):
...
class PlayerThemeCreationPayload(RequiredPlayerThemeCreationPayload, OptionalPlayerThemeCreationPayload):
    pass
