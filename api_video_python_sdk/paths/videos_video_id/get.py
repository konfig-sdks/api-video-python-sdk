...
class BaseApi(api_client.Api):
    ...
    def _get_video_object_mapped_args(
        self,
        video_id: str,
    ...
    async def _aget_video_object_oapg(
        self,
...
class GetVideoObjectRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_video_object(
        self,
        video_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_video_object_mapped_args(
            video_id=video_id,
        )
        return await self._aget_video_object_oapg(
    ...
    def get_video_object(
        ...
        return self._get_video_object_oapg(
            path_params=args.path,
        )

class GetVideoObject(BaseApi):
    ...
    async def aget_video_object(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_video_object(
            video_id=video_id,
            **kwargs,
        )
        if validate:
    ...
    def get_video_object(
        ...
        raw_response = self.raw.get_video_object(
            video_id=video_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
