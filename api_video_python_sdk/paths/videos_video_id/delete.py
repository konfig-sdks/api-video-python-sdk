...
class BaseApi(api_client.Api):
    ...
    def _delete_video_object_mapped_args(
        self,
        video_id: str,
    ...
    async def _adelete_video_object_oapg(
        self,
...
class DeleteVideoObjectRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_video_object(
        self,
        video_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_video_object_mapped_args(
            video_id=video_id,
        )
        return await self._adelete_video_object_oapg(
    ...
    def delete_video_object(
        ...
        return self._delete_video_object_oapg(
            path_params=args.path,
        )

class DeleteVideoObject(BaseApi):
    ...
    async def adelete_video_object(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_video_object(
            video_id=video_id,
            **kwargs,
        )
    ...
    def delete_video_object(
        ...
        raw_response = self.raw.delete_video_object(
            video_id=video_id,
        )
