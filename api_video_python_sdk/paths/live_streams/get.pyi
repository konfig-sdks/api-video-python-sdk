...
from api_video_python_sdk.model.live_stream_list_response import LiveStreamListResponse as LiveStreamListResponseSchema

from api_video_python_sdk.type.live_stream_list_response import LiveStreamListResponse

from ...api_client import Dictionary
from api_video_python_sdk.pydantic.live_stream_list_response import LiveStreamListResponse as LiveStreamListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = LiveStreamListResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_all_mapped_args(
        self,
        stream_key: typing.Optional[str] = None,
        ...
        if stream_key is not None:
            _query_params["streamKey"] = stream_key
        if name is not None:
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LiveStreamListResponsePydantic:
        ...
        if validate:
            return LiveStreamListResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(LiveStreamListResponsePydantic, raw_response.body)
