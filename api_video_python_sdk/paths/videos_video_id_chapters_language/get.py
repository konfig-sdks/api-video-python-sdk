...
class BaseApi(api_client.Api):
    ...
    def _get_chapter_by_language_mapped_args(
        self,
        video_id: str,
        language: str,
    ...
    async def _aget_chapter_by_language_oapg(
        self,
    ...
    def _get_chapter_by_language_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetChapterByLanguageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_chapter_by_language(
        self,
        video_id: str,
        language: str,
        **kwargs,
        ...
        args = self._get_chapter_by_language_mapped_args(
            video_id=video_id,
            language=language,
        )
        return await self._aget_chapter_by_language_oapg(
    ...
    def get_chapter_by_language(
        ...
        return self._get_chapter_by_language_oapg(
            path_params=args.path,
        )

class GetChapterByLanguage(BaseApi):
    ...
    async def aget_chapter_by_language(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_chapter_by_language(
            video_id=video_id,
            language=language,
            **kwargs,
        )
    ...
    def get_chapter_by_language(
        ...
        raw_response = self.raw.get_chapter_by_language(
            video_id=video_id,
            language=language,
        )
        if validate:
