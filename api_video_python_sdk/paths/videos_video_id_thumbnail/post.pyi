...
from api_video_python_sdk.model.video_thumbnail_upload_payload import VideoThumbnailUploadPayload as VideoThumbnailUploadPayloadSchema
...
from api_video_python_sdk.type.video_thumbnail_upload_payload import VideoThumbnailUploadPayload
...
from api_video_python_sdk.pydantic.video_thumbnail_upload_payload import VideoThumbnailUploadPayload as VideoThumbnailUploadPayloadPydantic
...
# body param
SchemaForRequestBodyMultipartFormData = VideoThumbnailUploadPayloadSchema


request_body_video_thumbnail_upload_payload = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    async def _aupload_thumbnail_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_video_thumbnail_upload_payload.serialize(body, content_type)
