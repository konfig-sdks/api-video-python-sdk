...
from api_video_python_sdk.model.video_upload_payload import VideoUploadPayload as VideoUploadPayloadSchema

from api_video_python_sdk.type.video_upload_payload import VideoUploadPayload
...
from api_video_python_sdk.pydantic.video_upload_payload import VideoUploadPayload as VideoUploadPayloadPydantic
...
class ContentRangeSchema(
    ...
    class MetaOapg:
        regex=[{
            'pattern': r'(?:bytes (?<from>\d+)-(?<to>\d+)|part (?<part>\d+))\/(?<total>\d+|\*)',
        }]
...
# body param
SchemaForRequestBodyMultipartFormData = VideoUploadPayloadSchema


request_body_video_upload_payload = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _ingest_video_from_source_mapped_args(
        self,
        video_id: str,
        file: typing.IO,
    ...
    async def _aingest_video_from_source_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/videos/{videoId}/source',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_video_upload_payload.serialize(body, content_type)
    ...
    def _ingest_video_from_source_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class IngestVideoFromSourceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aingest_video_from_source(
        self,
        video_id: str,
        file: typing.IO,
        content_range: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._ingest_video_from_source_mapped_args(
            video_id=video_id,
            file=file,
            content_range=content_range,
        )
        return await self._aingest_video_from_source_oapg(
            body=args.body,
    ...
    def ingest_video_from_source(
        ...
        return self._ingest_video_from_source_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class IngestVideoFromSource(BaseApi):
    ...
    async def aingest_video_from_source(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aingest_video_from_source(
            video_id=video_id,
            file=file,
            content_range=content_range,
            **kwargs,
    ...
    def ingest_video_from_source(
        ...
        raw_response = self.raw.ingest_video_from_source(
            video_id=video_id,
            file=file,
            content_range=content_range,
        )
