...
from api_video_python_sdk.model.player_themes_list_response import PlayerThemesListResponse as PlayerThemesListResponseSchema

from api_video_python_sdk.type.player_themes_list_response import PlayerThemesListResponse
...
from api_video_python_sdk.pydantic.player_themes_list_response import PlayerThemesListResponse as PlayerThemesListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PlayerThemesListResponseSchema
...
class PlayersRaw(BaseApi):
    ...
    async def aplayers(
        ...
        **kwargs,
        ...
        args = self._players_mapped_args(
            sort_by=sort_by,
            sort_order=sort_order,
            current_page=current_page,
            page_size=page_size,
        )
        return await self._aplayers_oapg(
...
class Players(BaseApi):
    ...
    async def aplayers(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PlayerThemesListResponsePydantic:
        raw_response = await self.raw.aplayers(
            sort_by=sort_by,
            sort_order=sort_order,
            current_page=current_page,
            page_size=page_size,
        ...
        if validate:
            return PlayerThemesListResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PlayerThemesListResponsePydantic, raw_response.body)
