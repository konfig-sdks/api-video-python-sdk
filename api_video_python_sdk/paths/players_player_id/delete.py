...
class BaseApi(api_client.Api):
    ...
    def _delete_player_mapped_args(
        self,
        player_id: str,
    ...
    async def _adelete_player_oapg(
        self,
...
class DeletePlayerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_player(
        self,
        player_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_player_mapped_args(
            player_id=player_id,
        )
        return await self._adelete_player_oapg(
    ...
    def delete_player(
        ...
        return self._delete_player_oapg(
            path_params=args.path,
        )

class DeletePlayer(BaseApi):
    ...
    async def adelete_player(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_player(
            player_id=player_id,
            **kwargs,
        )
    ...
    def delete_player(
        ...
        raw_response = self.raw.delete_player(
            player_id=player_id,
        )
