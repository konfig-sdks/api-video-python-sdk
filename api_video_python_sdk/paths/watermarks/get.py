...
from api_video_python_sdk.model.watermarks_list_response import WatermarksListResponse as WatermarksListResponseSchema

from api_video_python_sdk.type.bad_request import BadRequest
from api_video_python_sdk.type.watermarks_list_response import WatermarksListResponse

from ...api_client import Dictionary
from api_video_python_sdk.pydantic.watermarks_list_response import WatermarksListResponse as WatermarksListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = WatermarksListResponseSchema
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WatermarksListResponsePydantic:
        ...
        if validate:
            return WatermarksListResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WatermarksListResponsePydantic, raw_response.body)
