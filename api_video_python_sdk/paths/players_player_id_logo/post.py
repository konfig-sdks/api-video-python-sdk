...
from api_video_python_sdk.model.player_theme_upload_logo_payload import PlayerThemeUploadLogoPayload as PlayerThemeUploadLogoPayloadSchema
...
from api_video_python_sdk.type.player_theme_upload_logo_payload import PlayerThemeUploadLogoPayload
...
from api_video_python_sdk.pydantic.player_theme_upload_logo_payload import PlayerThemeUploadLogoPayload as PlayerThemeUploadLogoPayloadPydantic
...
# body param
SchemaForRequestBodyMultipartFormData = PlayerThemeUploadLogoPayloadSchema


request_body_player_theme_upload_logo_payload = api_client.RequestBody(
    content={
    ...
    async def _aupload_logo_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/players/{playerId}/logo',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_player_theme_upload_logo_payload.serialize(body, content_type)
...
class UploadLogoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupload_logo(
        self,
        player_id: str,
        file: typing.IO,
        link: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._upload_logo_mapped_args(
            player_id=player_id,
            file=file,
            link=link,
        )
        return await self._aupload_logo_oapg(
            body=args.body,
    ...
    def upload_logo(
        ...
        return self._upload_logo_oapg(
            body=args.body,
            path_params=args.path,
        )

class UploadLogo(BaseApi):
    ...
    async def aupload_logo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupload_logo(
            player_id=player_id,
            file=file,
            link=link,
            **kwargs,
    ...
    def upload_logo(
        ...
        raw_response = self.raw.upload_logo(
            player_id=player_id,
            file=file,
            link=link,
        )
