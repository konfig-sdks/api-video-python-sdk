...
class RemoveLogoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_logo(
        self,
        player_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_logo_mapped_args(
            player_id=player_id,
        )
        return await self._aremove_logo_oapg(
    ...
    def remove_logo(
        ...
        return self._remove_logo_oapg(
            path_params=args.path,
        )

class RemoveLogo(BaseApi):
    ...
    async def aremove_logo(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_logo(
            player_id=player_id,
            **kwargs,
        )
    ...
    def remove_logo(
        ...
        raw_response = self.raw.remove_logo(
            player_id=player_id,
        )
