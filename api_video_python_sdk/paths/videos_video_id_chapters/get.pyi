...
from api_video_python_sdk.model.chapters_list_response import ChaptersListResponse as ChaptersListResponseSchema
from api_video_python_sdk.model.not_found import NotFound as NotFoundSchema

from api_video_python_sdk.type.chapters_list_response import ChaptersListResponse
from api_video_python_sdk.type.not_found import NotFound

from ...api_client import Dictionary
from api_video_python_sdk.pydantic.chapters_list_response import ChaptersListResponse as ChaptersListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ChaptersListResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_by_video_mapped_args(
        self,
        video_id: str,
    ...
    async def _alist_by_video_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/videos/{videoId}/chapters',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListByVideoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_by_video(
        self,
        video_id: str,
        current_page: typing.Optional[int] = None,
        page_size: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._list_by_video_mapped_args(
            video_id=video_id,
            current_page=current_page,
            page_size=page_size,
        )
        return await self._alist_by_video_oapg(
    ...
    def list_by_video(
        ...
        return self._list_by_video_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListByVideo(BaseApi):
    ...
    async def alist_by_video(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ChaptersListResponsePydantic:
        raw_response = await self.raw.alist_by_video(
            video_id=video_id,
            current_page=current_page,
            page_size=page_size,
            **kwargs,
        ...
        if validate:
            return ChaptersListResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ChaptersListResponsePydantic, raw_response.body)
    ...
    def list_by_video(
        ...
        raw_response = self.raw.list_by_video(
            video_id=video_id,
            current_page=current_page,
            page_size=page_size,
        )
