...
class BaseApi(api_client.Api):
    ...
    def _delete_by_language_mapped_args(
        self,
        video_id: str,
        language: str,
    ...
    async def _adelete_by_language_oapg(
        self,
...
class DeleteByLanguageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_by_language(
        self,
        video_id: str,
        language: str,
        **kwargs,
        ...
        args = self._delete_by_language_mapped_args(
            video_id=video_id,
            language=language,
        )
        return await self._adelete_by_language_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_by_language(
        self,
        video_id: str,
        language: str,
    ) -> typing.Union[
        ...
        return self._delete_by_language_oapg(
            path_params=args.path,
        )

class DeleteByLanguage(BaseApi):
    ...
    async def adelete_by_language(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_by_language(
            video_id=video_id,
            language=language,
            **kwargs,
        )
    ...
    def delete_by_language(
        ...
        raw_response = self.raw.delete_by_language(
            video_id=video_id,
            language=language,
        )
