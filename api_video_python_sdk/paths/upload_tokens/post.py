...
from api_video_python_sdk.model.token_creation_payload import TokenCreationPayload as TokenCreationPayloadSchema
from api_video_python_sdk.model.upload_token import UploadToken as UploadTokenSchema

from api_video_python_sdk.type.token_creation_payload import TokenCreationPayload
...
from api_video_python_sdk.pydantic.token_creation_payload import TokenCreationPayload as TokenCreationPayloadPydantic
from api_video_python_sdk.pydantic.upload_token import UploadToken as UploadTokenPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = TokenCreationPayloadSchema


request_body_token_creation_payload = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = UploadTokenSchema
...
class BaseApi(api_client.Api):
    ...
    async def _agenerate_token_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_token_creation_payload.serialize(body, content_type)
...
class GenerateToken(BaseApi):
    ...
    async def agenerate_token(
        ...
        **kwargs,
        ...
        if validate:
            return UploadTokenPydantic(**raw_response.body)
        return api_client.construct_model_instance(UploadTokenPydantic, raw_response.body)
